...
from core.gpt import gpt_generate_word_by_german
...
if st.session_state["logged_in"]:
    ...
    with col1:
        german_word = utils.capitalize(st.text_input("German word:", "", placeholder ="Fill and press enter for GPT autofill"))
        ...
        if st.button("Add word"):
            st.session_state.dictionary = utils.add_word(
                german_word,
                english_word,
                article,
                russian_word,
    ...
    if st.session_state.dict_show_button:
        ...
        if st.button("Save dictionary", type="primary"):
            ...
            edited_df.to_json('data/dictionary.json', force_ascii=False)
